...
export default function Barra() {
  return (
    <Disclosure as="Barra" className="bg-gray-800">
      {({ open }) => (
        <>
          <div class="min-h-screen bg-gray-100">
            <div class="sidebar min-h-screen w-[3rem] overflow-hidden border-r hover:w-56 hover:bg-white hover:shadow-lg">
              <div class="flex h-screen flex-col justify-between pt-2 pb-6">
                <div>
                  <div class="w-max p-1.5">
                    <img
                      src="https://cdn-icons-png.flaticon.com/512/10848/10848856.png"
                      class="w-9 h-9"
                      alt=""
                    />
                  </div>
