...
export default function Home() {
  ...
  return (
    <div
    className="h-screen w-screen flex items-center justify-center" style={{
    ...
    >
      ...
      <main className="w-full sm:w-11/12 md:w-11/12 lg:w-11/12 xl:w-11/12 2xl:w-11/12 bg-blue-300 rounded-2xl border border-white text-white shadow-lg p-4"
      >
        <div className="flex items-center">
          <div className="flex items-center">
          <img className="max-w-full h-auto" src="https://www.iconarchive.com/download/i145204/iconarchive/incognito-animal-2/Dog.1024.png" alt="" />
          </div>
          <div className="p-10 h-auto">
            <p style={{ fontSize: '1.5em', color: "gray"}}>CARACTERISTICAS</p>
          <p style={{ fontSize: '1em', color: "blue", textAlign: "justify"}}>Esta es una solución de software que ayudara a las veterinarias a llevar un historial de consultas, podrá crear al dueño de la mascota o mascotas, asociarlas y saber que doctor lo atendió, adicionalmente se podrá asociar el correo electrónico para envío de historial medico de la mascota y facturación si se desea crear un modulo de facturación en este momento nos encontramos en versión beta por lo tanto las personas que deseen una versión de prueba deberán usar el software on-line y tener en cuenta que se realizaran actualizaciones continuas que pueden afectar el servicio o cambios significativos que cambien la forma y la ubicación de los elementos visuales. </p>
          </div>
        </div>
      </main>
    </div>
